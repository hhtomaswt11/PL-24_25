...
_lr_productions = [
  ...
  ('procedure_call_statement -> ID LPAREN expression_list RPAREN','procedure_call_statement',4,'p_procedure_call_statement','analise_sintatica.py',184),
  ('procedure_call_statement -> ID LPAREN RPAREN','procedure_call_statement',3,'p_procedure_call_statement','analise_sintatica.py',185),
  ('procedure_call_statement -> WRITELN LPAREN expression_list RPAREN','procedure_call_statement',4,'p_procedure_call_statement','analise_sintatica.py',186),
  ('procedure_call_statement -> WRITELN LPAREN RPAREN','procedure_call_statement',3,'p_procedure_call_statement','analise_sintatica.py',187),
  ('procedure_call_statement -> READLN LPAREN variable RPAREN','procedure_call_statement',4,'p_procedure_call_statement','analise_sintatica.py',188),
  ('procedure_call_statement -> READLN LPAREN RPAREN','procedure_call_statement',3,'p_procedure_call_statement','analise_sintatica.py',189),
  ('expression_list -> expression_list COMMA expression','expression_list',3,'p_expression_list','analise_sintatica.py',205),
  ('expression_list -> expression','expression_list',1,'p_expression_list','analise_sintatica.py',206),
  ('expression -> simple_expression','expression',1,'p_expression','analise_sintatica.py',216),
  ('expression -> simple_expression relop simple_expression','expression',3,'p_expression','analise_sintatica.py',217),
  ('relop -> EQ','relop',1,'p_relop','analise_sintatica.py',225),
  ('relop -> NEQ','relop',1,'p_relop','analise_sintatica.py',226),
  ('relop -> LT','relop',1,'p_relop','analise_sintatica.py',227),
  ('relop -> LE','relop',1,'p_relop','analise_sintatica.py',228),
  ('relop -> GT','relop',1,'p_relop','analise_sintatica.py',229),
  ('relop -> GE','relop',1,'p_relop','analise_sintatica.py',230),
  ('relop -> IN','relop',1,'p_relop','analise_sintatica.py',231),
  ('simple_expression -> term','simple_expression',1,'p_simple_expression','analise_sintatica.py',236),
  ('simple_expression -> simple_expression addop term','simple_expression',3,'p_simple_expression','analise_sintatica.py',237),
  ('addop -> PLUS','addop',1,'p_addop','analise_sintatica.py',245),
  ('addop -> MINUS','addop',1,'p_addop','analise_sintatica.py',246),
  ('addop -> OR','addop',1,'p_addop','analise_sintatica.py',247),
  ('term -> factor','term',1,'p_term','analise_sintatica.py',252),
  ('term -> term mulop factor','term',3,'p_term','analise_sintatica.py',253),
  ('mulop -> TIMES','mulop',1,'p_mulop','analise_sintatica.py',261),
  ('mulop -> DIVIDE','mulop',1,'p_mulop','analise_sintatica.py',262),
  ('mulop -> DIV','mulop',1,'p_mulop','analise_sintatica.py',263),
  ('mulop -> MOD','mulop',1,'p_mulop','analise_sintatica.py',264),
  ('mulop -> AND','mulop',1,'p_mulop','analise_sintatica.py',265),
  ('factor -> variable','factor',1,'p_factor','analise_sintatica.py',270),
  ('factor -> INTEGER','factor',1,'p_factor','analise_sintatica.py',271),
  ('factor -> REAL','factor',1,'p_factor','analise_sintatica.py',272),
  ('factor -> STRING','factor',1,'p_factor','analise_sintatica.py',273),
  ('factor -> TRUE','factor',1,'p_factor','analise_sintatica.py',274),
  ('factor -> FALSE','factor',1,'p_factor','analise_sintatica.py',275),
  ('factor -> LPAREN expression RPAREN','factor',3,'p_factor','analise_sintatica.py',276),
  ('factor -> NOT factor','factor',2,'p_factor','analise_sintatica.py',277),
  ('factor -> function_call','factor',1,'p_factor','analise_sintatica.py',278),
  ('expression -> variable COLON INTEGER','expression',3,'p_formatted_expression','analise_sintatica.py',296),
  ('expression -> variable COLON INTEGER COLON INTEGER','expression',5,'p_formatted_expression','analise_sintatica.py',297),
  ('function_call -> ID LPAREN expression_list RPAREN','function_call',4,'p_function_call','analise_sintatica.py',306),
  ('function_call -> ID LPAREN RPAREN','function_call',3,'p_function_call','analise_sintatica.py',307),
  ('function_declaration -> FUNCTION ID LPAREN param_list RPAREN COLON type_spec SEMICOLON function_block SEMICOLON','function_declaration',10,'p_function_declaration','analise_sintatica.py',315),
  ('param_list -> param_list SEMICOLON param','param_list',3,'p_param_list','analise_sintatica.py',320),
  ('param_list -> param','param_list',1,'p_param_list','analise_sintatica.py',321),
  ('param -> id_list COLON type_spec','param',3,'p_param','analise_sintatica.py',329),
  ('halt_statement -> HALT SEMICOLON','halt_statement',2,'p_halt_statement','analise_sintatica.py',335),
  ('empty -> <empty>','empty',0,'p_empty','analise_sintatica.py',341),
]
